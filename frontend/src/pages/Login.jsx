  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography variant="h4" component="h2" sx={{ fontWeight: 600, mb: 3, color: theme.palette.text.primary }}> {/* Black text */}
        ...
        <form onSubmit={handleSubmit} style={{ width: '100%' }}>
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <PersonOutline sx={{ color: theme.palette.text.secondary }} /> {/* Adjusted for light theme */}
                  </InputAdornment>
                ),
              }}
            />
          ...
          <StyledTextField
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <Lock sx={{ color: theme.palette.text.secondary }} /> {/* Adjusted for light theme */}
                </InputAdornment>
              ),
              endAdornment: (
                <InputAdornment position="end">
                  <IconButton
                    ...
                    edge="end"
                    sx={{ color: theme.palette.text.secondary }} /* Adjusted for light theme */
                  >
          ...
          {isLogin && (
            <Box sx={{ textAlign: 'right', mb: 2 }}>
              <MuiLink
                ...
                sx={{
                  color: theme.palette.primary.main, // Orange from theme
                  textDecoration: 'none',
          ...
          {isLogin && (
            <Box sx={{ my: 3 }}>
              <Typography variant="body2" sx={{ color: theme.palette.text.secondary }}> {/* Adjusted for light theme */}
                or continue with
              </Typography>
          ...
          <Typography variant="body2" sx={{ color: theme.palette.text.secondary, mt: 3 }}> {/* Adjusted for light theme */}
